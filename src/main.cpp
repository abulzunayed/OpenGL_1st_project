...
int main() {
	...
	Material* marika = new Material("E:/C++ project3/OpenGL/OpenGL_1st_project/img/marika_matsumoto.jpg");
	Material* mask = new Material("E:/C++ project3/OpenGL/OpenGL_1st_project/img/mask.jpg");

	unsigned int shader = make_shader(
		"E:/C++ project3/OpenGL/OpenGL_1st_project/src/shaders/vertex.txt", 
		"E:/C++ project3/OpenGL/OpenGL_1st_project/src/shaders/fragment.txt"
	);
